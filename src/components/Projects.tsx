            ...
            >
              ...
              <div className="mt-4">
                {project.techStack.map((tech) => (
                  <span
                    key={tech}
                    className="bg-gray-900 text-purple-600 hover:text-pink-600 px-2 py-1 mr-2 inline-flex items-center rounded-full mb-2 transition-colors duration-200 ease-in-out"
                  >
