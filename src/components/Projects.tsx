      ...
      <div className="flex flex-col items-center justify-center p-4 lg:p-8">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 lg:mt-12 lg:grid-cols-3">
          {projects.map((project) => (
            <div
              key={project.name}
              className="bg-gray-900 p-4 shadow-md rounded-lg flex flex-col transition-transform duration-200 ease-in-out hover:scale-105"
            >
              <a
                href={project.link}
                target="_blank"
                className="flex items-center cursor-pointer transition-transform duration-200 ease-in-out hover:scale-105 text-purple-600 hover:text-pink-600"
              >
              ...
              <div className="mt-4">
                {project.techStack.map((tech) => (
                  <span
                    key={tech}
                    className="bg-gray-900 text-purple-600 hover:text-pink-600 px-2 py-1 mr-2 inline-flex items-center rounded-full mb-2 group transition-colors duration-200 ease-in-out"
                  >
