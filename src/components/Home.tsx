export default function Home() {
  return (
    <div className="container mx-auto flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 mt-8 sm:mt-16 lg:mt-20">
      <h1 className="text-4xl font-bold text-gray-800 my-8 sm:text-5xl lg:text-6xl">
        Hello, I'm Szakacsi Ferenc-Adam!
      </h1>
      <p className="text-lg text-gray-600 mb-8 sm:text-xl lg:text-2xl">
...
function Section({
  ...
  return (
    <div className="bg-white p-8 shadow-md rounded-lg mb-8 transition-all duration-200 hover:shadow-2xl">
      <h2 className="text-2xl font-bold text-gray-800 mb-4 transition-colors duration-200 hover:text-blue-500">
        {title}
      </h2>
      <p className="text-gray-600 mb-6 transition-colors duration-200 hover:text-gray-800">
        {description}
      </p>
    </div>
  );
